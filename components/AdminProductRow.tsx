...
const AdminProductRow: React.FC<AdminProductRowProps> = ({ product, onUpdate, onDelete }) => {
  ...
  if (isEditing) {
    return (
      <div className="bg-gray-800 p-4 rounded-lg border-2 border-pink-500 space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 items-start">
           <div className="flex flex-col items-center">
             ...
             <label htmlFor={`image-${product.id}`} className="mt-2 text-xs text-purple-400 hover:text-pink-400 cursor-pointer">Alterar</label>
           </div>
  ...
  return (
    <div className="bg-gray-800/50 p-3 rounded-lg border border-purple-900 flex flex-col md:flex-row items-center gap-4">
